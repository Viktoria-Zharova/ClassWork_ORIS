...
import models.User;
import repository.CookiesRepository;
import repository.UsersRepository;
import repository.CookiesRepositoryJdbcImpl;
...
public class AuthenticationServlet extends HttpServlet {
    ...
    private void saveSessionInDatabase(long userId, UUID uuid) {
        try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            String sql = "INSERT INTO session_data (user_id, uuid) VALUES (?, ?)";
